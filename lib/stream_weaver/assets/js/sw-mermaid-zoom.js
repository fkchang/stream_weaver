...
(function () {
  ...
  function cloneSvgWrapper(svg) {
    ...
    // purpose. Clearing max-width alone (a first draft) didn't touch
    // this: width="100%" was still the actual problem. Fixed by setting
    // concrete pixel dimensions read straight from the SVG's own viewBox
    // -- which IS "natural size" -- so nothing here depends on any
    // ancestor's computed width at all.
